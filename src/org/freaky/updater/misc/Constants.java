 ...
 */
package org.freaky.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "org.freaky.build_version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "org.freaky.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "org.freaky.build_type";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "freaky.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "freaky.updater.uri";
